...
class LikePost:
    ...
    def simulate_long_break(self):
        # Long break to simulate a user stepping away (5 to 10 minutes)
    ...
    def like_post(self, amount):
        for i in range(amount):
            ...
            # 40% chance to scroll, 20% chance to view post, and 10% chance to take a long break.
            ...
            # Every 50 likes, take a mandatory long break to mimic daily inactivity.
            if i != 0 and i % 50 == 0:
                self.simulate_long_break()
